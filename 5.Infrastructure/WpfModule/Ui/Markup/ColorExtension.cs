...
using Infrastructure.BaseComponents.Components.Colors;
using Infrastructure.WpfModule.Extensions;

namespace Infrastructure.WpfModule.Ui.Markup
{
    /// <summary>
    ...
    public class ColorExtension: MarkupExtension
    {
        ...
        /// <summary>
        /// Приращение прозрачночти базового цвета (от -255 до 255).
        /// </summary>
